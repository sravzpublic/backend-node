...
var User = require('../../app/models/user.server.model'); // Import User Model
...
const cipher = require('../../app/ngx-admin/api/common/auth/cipherHelper');
...
module.exports = function(app, passport) {
    ...
    passport.serializeUser(function(user, done) {
        ...
        if (user.active) {
            ...
            if (user.error) {
                ...
                token = cipher.generateResponseTokens(user); // If account active, give user token
            }
        } else {
    ...
    passport.use(new TwitterStrategy({
			...
			callbackURL: config.twitter.twitter_callback,

...
module.exports = {
	...
	google_callback: 'https://datadev.sravz.com/redirect-google',
    ...
    app: {
		...
		allowedOrigins: ['https://datadev.sravz.com', 'https://webdev.sravz.com', 'https://portfoliodev.sravz.com',
						//Socket.io required /
						 'https://datadev.sravz.com/', 'https://webdev.sravz.com/', 'https://portfoliodev.sravz.com/'],
        cacheDirectory: "/tmp/sravzportfoliodiskcache/",
		BACKEND_PY_TOPIC: "development_backend-py",
		BACKEND_RUST_TOPIC: "development_backend-rust",
		kafka_analytics2_topic: "development_backend-py",
        BACKEND_NODE_TOPIC: "development_backend-node" + os.hostname(),
		...
		portfolioServiceBase : 'https://portfoliodev.sravz.com',
		analyticsServiceBase : 'https://analyticsdev.sravz.com',
		analyticsSocketServiceBase : 'wss://analyticsdev.sravz.com',
        smartThingsOauth: {
            ...
            sravzRedirectUri: 'https://datadev.sravz.com/authcomplete.html'
		},
		MESSAGE_IDS: {
			'respond_to_ping': 0,
	...
	frontEnd: {
		domain: 'https://datadev.sravz.com',
	},

...
module.exports = {
	...
	google_callback: 'http://localhost:4200/redirect-google',
	FACEBOOK_APP_ID: process.env.FACEBOOK_APP_ID,
	FACEBOOK_CLIENT_SECRET: process.env.FACEBOOK_CLIENT_SECRET,
	app: {
		title: 'backend-node - Vagrant Environment',
		https_pfx: process.env.PFX_PATH || './config/sslcerts/sravz.pfx',
		https_pfx_password: process.env.PFX_PASSWORD,
		https_port: process.env.NODE_PORT || 3030,
		allowedOrigins: ['https://webvagrant.sravz.com', 'https://datavagrant.sravz.com', 'https://vagrant.sravz.com', 'http://localhost:8080', 'http://localhost:3030/', 'http://localhost:4200', 'http://localhost:4201'],
		smartThingsOauth: {
			oauth2Options: {
				client: {
					id: '',
			...
			sravzRedirectUri: 'https://web.vagrant.sravz.com/authcomplete.html'
		},
		githubOauth: {
			oauth2Options: {
				client: {
					id: '66998014fe490e555c71',
					secret: 'cc270abc0c242b9bfc0e2204944049b5b8560a47'
				},
				auth: {
					tokenHost: 'https://graph.api.smartthings.com'
				}
		...
		linkedInOauth: {
			...
			tokenEndpoint: 'https://graph-na02-useast1.api.smartthings.com',
			tokenCallBackUrl: '/api/smarthingstokencallback',
			sravzRedirectUri: 'http://127.0.0.1:3000/auth/linkedin/callback'
		},
		BACKEND_PY_TOPIC: "vagrant_backend-py",
		BACKEND_RUST_TOPIC: "vagrant_backend-rust",
		kafka_analytics2_topic: "vagrant_backend-py",
        BACKEND_NODE_TOPIC: "vagrant_backend-node" + os.hostname(),
		kakfa_group_portfolio_name: "group_vagrant_portfolio1",

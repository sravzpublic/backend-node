...
module.exports = {
    ...
    app: {
		...
		allowedOrigins: ['https://datastaging.sravz.com', 'https://webstaging.sravz.com', 'https://portfoliostaging.sravz.com',
						 'https://datastaging.sravz.com/', 'https://webstaging.sravz.com/', 'https://portfoliostaging.sravz.com/',
						 'https://nodestaging.sravz.com/', 'https://nodestaging.sravz.com'],
        cacheDirectory: "/tmp/sravzportfoliodiskcache/",
		BACKEND_PY_TOPIC: "staging_backend-py",
		BACKEND_RUST_TOPIC: "staging_backend-rust",
        BACKEND_NODE_TOPIC: "staging_backend-node" + os.hostname(),
        ...
        smartThingsOauth: {
            ...
            sravzRedirectUri: 'https://datastaging.sravz.com/authcomplete.html'
        },
		MESSAGE_IDS: {
			'respond_to_ping': 0,
	...
	frontEnd: {
		domain: 'https://datastaging.sravz.com',
	},

...
module.exports = {
	...
	google_callback: 'https://sravz.com/redirect-google',
    ...
    app: {
        ...
        https_port: process.env.NODE_PORT || 443,
        production: true,
		allowedOrigins: ['https://sravz.com', 'https://portfolio.sravz.com', 'https://data.sravz.com',
						 'https://www.sravz.com/', 'https://portfolio.sravz.com/', 'https://data.sravz.com/',
						 'https://node.sravz.com', 'https://node.sravz.com/',
						'www.sravz.com/', 'www.sravz.com', 'https://www.sravz.com'],
		cacheDirectory: "/tmp/sravzportfoliodiskcache/",
		BACKEND_PY_TOPIC: "production_backend-py",
		BACKEND_RUST_TOPIC: "production_backend-rust",
        BACKEND_NODE_TOPIC: "production_backend-node" + os.hostname(),
        ...
        smartThingsOauth: {
            ...
            sravzRedirectUri: 'https://sravz.com/authcomplete.html'
        },
		MESSAGE_IDS: {
			'respond_to_ping': 0,
